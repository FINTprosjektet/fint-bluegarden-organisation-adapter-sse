...
public class DefaultBlueGardenService implements BlueGardenService {
    ...
    public void init() {
        ...
        GetAnsattListSOAPQSService employeeService = new GetAnsattListSOAPQSService();
        BasicHttpBindingIOrgStructureServiceQSService orgService = new BasicHttpBindingIOrgStructureServiceQSService();
        employeePort = employeeService.getGetAnsattListSOAPQSPort();
        orgPort = orgService.getBasicHttpBindingIOrgStructureServiceQSPort();
        Map<String, Object> employeeRequestContext = ((BindingProvider) employeePort).getRequestContext();
        Map<String, Object> orgRequestContext = ((BindingProvider) orgPort).getRequestContext();
